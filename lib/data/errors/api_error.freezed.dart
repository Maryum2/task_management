...
class _$ErrorResponseImpl implements _ErrorResponse {
  const _$ErrorResponseImpl(
      {this.statusCode, this.message, required this.success});
  ...
  @override
  String toString() {
    return 'ErrorResponse(statusCode: $statusCode, message: $message, success: $success)';
  }
...
abstract class _ErrorResponse implements ErrorResponse {
  const factory _ErrorResponse(
      {final int? statusCode,
      final String? message,
      required final bool success}) = _$ErrorResponseImpl;
